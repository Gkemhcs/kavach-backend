...
// CasbinBackend wraps a Casbin enforcer
type CasbinBackend struct {
	enforcer *casbin.Enforcer
}

// Type returns the type of the enforcer backend
func (c *CasbinBackend) Type() string {
	return "casbin"
}

// Value returns the actual enforcer value
func (c *CasbinBackend) Value() interface{} {
	return c.enforcer
}

// GetCasbinEnforcer safely extracts the Casbin enforcer from the backend
func (c *CasbinBackend) GetCasbinEnforcer() *casbin.Enforcer {
	return c.enforcer
}

// NewEnforcer creates a new CasbinEnforcer instance
func NewCasbinEnforcer(logger *logrus.Logger, cfg AdapterConfig) (*CasbinEnforcer, error) {
...
// GetEnforcer returns the underlying Casbin enforcer wrapped in CasbinBackend
func (e *CasbinEnforcer) GetEnforcer() EnforcerBackend {
	return &CasbinBackend{enforcer: e.enforcer}
}
...
func (e *CasbinEnforcer) AddResourceHierarchy(parentResource, childResource string) error {
...
func (e *CasbinEnforcer) RemoveResourceHierarchy(parentResource, childResource string) error {
...
func (e *CasbinEnforcer) AddResourceOwner(userID, resource string) error {
...
func (e *CasbinEnforcer) RemoveResource(resource string) error {
...
func (e *CasbinEnforcer) AddUserToGroup(userID, groupID string) error {
	userSubject := fmt.Sprintf("user:%s", userID)
...
func (e *CasbinEnforcer) RemoveUserFromGroup(userID, groupID string) error {
	userSubject := fmt.Sprintf("user:%s", userID)
	groupName := fmt.Sprintf("group:%s", groupID)
...
func (e *CasbinEnforcer) DeleteUserGroup(groupID string) error {
	groupName := fmt.Sprintf("group:%s", groupID)
...
func (e *CasbinEnforcer) GrantRole(subject, role, resource string) error {
...
func (e *CasbinEnforcer) GrantRoleWithPermissions(userID, role, resource string) error {
	userSubject := fmt.Sprintf("user:%s", userID)
...
func (e *CasbinEnforcer) RevokeRole(subject, role, resource string) error {
...
func (e *CasbinEnforcer) RevokeRoleCascade(subject, role, resource string) error {
...
func (e *CasbinEnforcer) CheckPermission(userID, action, resource string) (bool, error) {
	userSubject := fmt.Sprintf("user:%s", userID)
...
func (e *CasbinEnforcer) getParentResources(resource string) []string {
	var parents []string
...
func (e *CasbinEnforcer) CheckPermissionEx(userID, action, resource string) (bool, []string, error) {
	userSubject := fmt.Sprintf("user:%s", userID)
...
func (e *CasbinEnforcer) GetUserRoles(userID string) ([]string, error) {
...
func (e *CasbinEnforcer) GetUserGroups(userID string) ([]string, error) {
...
func (e *CasbinEnforcer) GetUsersForGroup(groupID string) ([]string, error) {
	groupName := fmt.Sprintf("group:%s", groupID)
	users, err := e.enforcer.GetUsersForRole(groupName)
	if err != nil {
		e.logger.Errorf("Failed to get users for group %s: %v", groupName, err)
...
func (e *CasbinEnforcer) GetResourcePermissions(resource string) ([][]string, error) {
...
func (e *CasbinEnforcer) isChildResource(childResource, parentResource string) bool {
...
func (e *CasbinEnforcer) getActionsForRole(role string) []string {
	switch role {
	case "owner":
...
func (e *CasbinEnforcer) DebugPolicies() {
...
func (e *CasbinEnforcer) DebugUserPermissions(userID string) {
	userSubject := fmt.Sprintf("user:%s", userID)
...
func (e *CasbinEnforcer) DebugResourcePermissions(resource string) {
